<<<<<<< HEAD:SSM/src/main/webapp/index.jsp
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="email_update"
								placeholder="email" name="empEmail">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							id="gender1_update" value="M" name="empGender">
								男
							</label> <label class="radio-inline"> <input type="radio"
							 id="gender2_update" value="W" name="empGender">
								女
							</label>
                          </div>
					</div>
			...
			<div class="modal-body">
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="radio-inline"> <input type="radio"
							id="gender1_add" value="M" name="empGender">
								男
							</label> <label class="radio-inline"> <input type="radio"
							 id="gender2_add" value="W" name="empGender">
								女
							</label>
                          </div>
					</div>
			...
			$.ajax({
				...
				success : function(result) {
					...
					if(result.code==100){
						...
						//console.log(result);
						//如果有哪个字段的错误信息就显示哪个字段
						if (undefined == result.extend.erroFiled.empEmail) {
							//显示邮箱错误信息
							show_validate_msg("#email_add","error",result.extend.erroFiled.empEmail);
						}
						if (undefined == result.extend.erroFiled.empName) {
							//显示用户错误信息
							show_validate_msg("#empName_add","error",result.extend.erroFiled.empName);
						}
		...
		function getEmp(id){
			$.ajax({
				...
				success:function(result){
					...
					$("#email_update").val(empData.empEmail);
					//#empupdatemodal input[name=workerGender]中name为一个别名，可以随意取
...
>>>>>>> 563df7c76f4e959bb949b7ef3f76cd77dafa3b8a:src/main/webapp/WEB-INF/index.jsp
