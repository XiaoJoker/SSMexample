...
public class MSG {
	/*{"code":100,"msg":"处理成功！","extend":{"pageInfo":{"pageNum":1,
	 ...
	 * 1,"department":{"deptId":1,"deptName":"开发部"}}
